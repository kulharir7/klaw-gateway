    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "klaw node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["klaw node status", "Check node host service status."],
          ["klaw node install", "Install the node host service."],
          ["klaw node restart", "Restart the installed node host service."],
