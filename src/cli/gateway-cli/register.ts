      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["klaw gateway run", "Run the gateway in the foreground."],
            ["klaw gateway status", "Show service status and probe reachability."],
            ["klaw gateway discover", "Find local and wide-area gateway beacons."],
            ["klaw gateway call health", "Call a gateway RPC method directly."],
