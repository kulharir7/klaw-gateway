    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["klaw channels list", "List configured channels and auth profiles."],
          ["klaw channels status --probe", "Run channel status checks and probes."],
          [
            "klaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["klaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
