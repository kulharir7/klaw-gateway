...
const SANDBOX_EXAMPLES = {
  main: [
    ["klaw sandbox list", "List all sandbox containers."],
    ["klaw sandbox list --browser", "List only browser containers."],
    ["klaw sandbox recreate --all", "Recreate all containers."],
    ["klaw sandbox recreate --session main", "Recreate a specific session."],
    ["klaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["klaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["klaw sandbox list", "List all sandbox containers."],
    ["klaw sandbox list --browser", "List only browser containers."],
    ["klaw sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["klaw sandbox recreate --all", "Recreate all containers."],
    ["klaw sandbox recreate --session main", "Recreate a specific session."],
    ["klaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["klaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["klaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["klaw sandbox explain", "Show effective sandbox config."],
    ["klaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["klaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["klaw sandbox explain --json", "JSON output."],
  ],
} as const;
